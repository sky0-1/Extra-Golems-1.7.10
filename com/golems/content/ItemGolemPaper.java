...
{	
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
	{
		if(GuiScreen.isShiftKeyDown())
		{
			...
			par3List.add(trans("tile.blockGold.name") + ", " + trans("tile.icePacked.name") + ", " + trans("tile.netherBrick.name") + ",");
			par3List.add(trans("tile.blockIron.name") + ", " + trans("tile.sandStone.name") + ", " + trans("tile.clayHardened.name") + ",");
			par3List.add(trans("material.stained_clay") + ", " + trans("material.log") + ", " + trans("tile.tnt.name") + ", " + trans("tile.blockCoal.name") + ",");
			par3List.add(trans("tile.blockRedstone.name") + ", " + trans("tile.blockLapis.name") + ",");
			par3List.add(trans("tile.clay.name") + ", " + trans("tile.bookshelf.name") + ", " + trans("tile.sponge.name") + ",");
			par3List.add(trans("tile.melon.name") + ", " + trans("tile.cloth.name") + ", " + trans("tile.hayBlock.name") + ", " + trans("material.leaf_block"));		
